...
INSERT INTO public.artist (name, photo, biography)

values

('Bon Jovi', 'https://example.com/Bonjovi.jpg', 'Bon Jovi is an American rock band formed in Sayreville, New Jersey, in 1983. The band has sold over 130 million records worldwide and is one of the best-selling bands of all time.'),

('Journey', 'https://example.com/Journey.jpg','Journey is an American rock band formed in San Francisco in 1973. The band has sold over 90 million records worldwide and is one of the best-selling bands of all time.');
...
INSERT INTO public."user" (id, username, "password", email, premium) VALUES(uuid_generate_v4(), 'admin', 'admin', 'admin@spotify-clone.com', false);
